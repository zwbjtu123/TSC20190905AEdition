...
import static development.TimeSeriesClassification.dropboxPath;
import static development.TimeSeriesClassification.fileNames;
...
public class DataSets
{
    ...
    public final static String path = "C:\\LocalData\\Dropbox\\"; //Tony: you only need to change this line.

    public static String dropboxPath    = path + "TSC Problems\\";
    public static String uciPath        = path + "UCI Classification Problems\\";
    public static String ucrPath        = path + "TSC Problems\\";
...
//ALL of our TSC data sets  
    ...
    public static void processUCRData()
    {
        ...
        for (String s : ucrNames)
        {
            ...
            {
                String line = trainF.readStringIgnoreWhite();
                ...
                try
                {
                    ...
                    double c = Double.valueOf(split[1]).doubleValue();
                    if ((c - 1) != train.instance(i).classValue())
                    {
                        System.out.println(" ERROR MISMATCH IN CLASS " + s + " from instance " + i + " ucr =" + c + " mine = " + train.instance(i).classValue());
                        System.exit(0);
                    }
                }
                catch (Exception e)
    ...
    public static void dataDescription(String[] fileNames)
    {
        ...
        try
        {
            ...
            {
                Instances test = ClassifierTools.loadData(dropboxPath + fileNames[i] + "\\" + fileNames[i] + "-train");
                Instances train = ClassifierTools.loadData(dropboxPath + fileNames[i] + "\\" + fileNames[i] + "-test");
