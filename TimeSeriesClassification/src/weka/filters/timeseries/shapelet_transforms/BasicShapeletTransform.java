 ...
 */
public class BasicShapeletTransform extends SimpleBatchFilter {
     ...
     * @param shapes
     */
    public BasicShapeletTransform(ArrayList<Shapelet> shapes) {
        this();
     ...
     */
    public BasicShapeletTransform(int k) {
     ...
     */
    public BasicShapeletTransform(int k, int minShapeletLength, int maxShapeletLength) {
     ...
     * filter
     */
    public BasicShapeletTransform(int k, int minShapeletLength, int maxShapeletLength, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice) {
     ...
     * this candidate
     */
    protected Shapelet checkCandidate(Instance series, int seriesId, int start, int length) {
        ...
        Shapelet shapelet = new Shapelet(candidate, dataSourceIDs[seriesId], start, this.qualityMeasure);
