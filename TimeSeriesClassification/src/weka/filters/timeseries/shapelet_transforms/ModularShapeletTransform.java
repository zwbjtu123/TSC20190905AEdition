...
public class ModularShapeletTransform extends FullShapeletTransform
{
     ...
     */
    public ModularShapeletTransform()
    {
     ...
     * @param shapes
     */
    public ModularShapeletTransform(ArrayList<Shapelet> shapes)
    {
        this();
     ...
     */
    public ModularShapeletTransform(int k)
    {
     ...
     */
    public ModularShapeletTransform(int k, int minShapeletLength, int maxShapeletLength)
    {
     ...
     * filter
     */
    public ModularShapeletTransform(int k, int minShapeletLength, int maxShapeletLength, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice)
    {
     ...
     * @throws Exception
     */
    public static ModularShapeletTransform createFilterFromFile(String fileName) throws Exception
    {
     ...
     * @throws Exception
     */
    public static ModularShapeletTransform createFilterFromFile(String fileName, int maxShapelets) throws Exception
    {
        ...
        ModularShapeletTransform sf = new ModularShapeletTransform();
