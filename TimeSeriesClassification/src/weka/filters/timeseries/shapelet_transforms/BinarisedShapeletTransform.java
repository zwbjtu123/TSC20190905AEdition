...
public class BinarisedShapeletTransform extends ShapeletTransform
{
    ...
    {    
        ...
        while(traverse[0] || traverse[1])
        {
            ...
            for(int j=0; j<2; j++)
            {
                ...
                currentDist = calculateBestDistance(pos[j], timeSeries, candidate, sortedIndices, bestDist, sum[j], sumsq[j]);  
    ...
    public static void test()
    {
        ...
        BinarisedShapeletTransform.onlineSubsequenceDistance(subseq, sortedIndexes, normSeries, startPos);
        System.out.println("BinarisedShapeletTransform.subseqDistOpCount: " + BinarisedShapeletTransform.subseqDistOpCount);
