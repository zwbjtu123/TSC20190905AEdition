...
import statistics.simulators.SimulateShapeletDataset;
    ...
    public static Classifier createClassifier(String str) throws RuntimeException{
        ...
        switch(str){
            ...
            case "DTW":
                c=new DTW_1NN();
                break;
            case "ACF":   case "PS": case "PSACF": case "ACFPS": case "AR":
                c=new PSACF_Ensemble();
                ((PSACF_Ensemble)c).setClassifierType("hesca");
                ((PSACF_Ensemble)c).setTransformType(str);
                break;
...
//        for(int:)
        ...
        switch(str){
            ...
            case "Shapelet": 
                ...
                data=SimulateShapeletDataset.getShapeletData(seriesLength,casesPerClass);
                break;
            default:
    ...
    public static double simulatorExperiment(String dataSimulator, String classifier, int fold){
        ...
        Instances test= simulateData(dataSimulator,fold);
